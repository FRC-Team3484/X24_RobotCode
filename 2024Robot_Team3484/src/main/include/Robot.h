...
class Robot : public frc::TimedRobot {
    ...
    private:
        ...
        IntakeSubsystem _intake{IntakeConstants::PIVOT_MOTOR_CAN_ID, IntakeConstants::DRIVE_MOTOR_CAN_ID, IntakeConstants::PIECE_SENSOR_DI_CH, IntakeConstants::ARM_SENSOR_DI_CH, LauncherConstants::TRANSFER_MOTOR_ID, IntakeConstants::PIVOT_PID_CONSTANTS, IntakeConstants::PID_OUTPUTRANGE_MAX, IntakeConstants::PID_OUTPUTRANGE_MIN, 60};
        #endif
        ...
        AutonGenerator _auton_generator{&_drivetrain, &_launcher, &_intake, &_vision};

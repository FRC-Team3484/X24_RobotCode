...
//joystick
double Operator_Interface::OpenLoopControlLeft() {frc::SmartDashboard::GetBoolean("testing",true) ? frc::ApplyDeadband(_operator_controller.GetRawAxis(TESTING_OPEN_LOOP_LEFT), TESTING_DEADBAND) : 0;}
double Operator_Interface::OpenLoopControlRight() {frc::SmartDashboard::GetBoolean("testing",true) ? frc::ApplyDeadband(_operator_controller.GetRawAxis(TESTING_OPEN_LOOP_RIGHT), TESTING_DEADBAND) : 0;}
// Hotkeys
bool Operator_Interface::LauncherHotKey(){frc::SmartDashboard::GetBoolean("testing",true) ? _operator_controller.GetRawButton(Hotkey::LAUNCHER_HK) : false;}
bool Operator_Interface::IntakeHotKey(){frc::SmartDashboard::GetBoolean("testing",true) ?  _operator_controller.GetRawButton(Hotkey::INTAKE_HK) : false;}
double Operator_Interface::ClimberHotKey(){frc::SmartDashboard::GetBoolean("testing",true) ? _operator_controller.GetRawAxis(Hotkey::CLIMBER_HK) : 0;}
...
bool Operator_Interface::ExtendIntake() {return _operator_controller.GetRawButton(EJECT);}
bool Operator_Interface::IgnoreVision() {return _operator_controller.GetRawButton(EXTEND);}

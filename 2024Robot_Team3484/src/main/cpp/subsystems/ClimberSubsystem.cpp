...
ClimberSubsystem::ClimberSubsystem(
    ...
    int right_sensor_di_ch
        ...
        _left_climber_motor{left_motor_can_id, rev::CANSparkMax::MotorType::kBrushless},
        _right_climber_motor{right_motor_can_id, rev::CANSparkMax::MotorType::kBrushless},
        _left_motor_sensor{left_sensor_di_ch},
        _right_motor_sensor{right_sensor_di_ch}
    {

    _right_climber_motor.RestoreFactoryDefaults();
    _left_climber_motor.RestoreFactoryDefaults();

    _left_climber_motor.SetIdleMode(rev::CANSparkMax::IdleMode::kBrake);
    _right_climber_motor.SetIdleMode(rev::CANSparkMax::IdleMode::kBrake);
